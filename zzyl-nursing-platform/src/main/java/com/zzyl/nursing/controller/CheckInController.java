...
@GetMapping("/list")
@ApiOperation("查询入住信息列表")
    public TableDataInfo<List<CheckIn>> list(@ApiParam(value = "入住信息查询条件") CheckIn checkIn)
    {
        startPage();
    ...
    @PostMapping("/export")
    @ApiOperation("导出入住信息列表")
    public void export(HttpServletResponse response, @ApiParam(value = "入住信息查询条件") CheckIn checkIn)
    {
        List<CheckIn> list = checkInService.selectCheckInList(checkIn);
    ...
    @GetMapping(value = "/{id}")
    @ApiOperation("获取入住信息详细信息")
    public R<CheckIn> getInfo(@ApiParam(value = "入住信息ID", required = true)
    ...
    @PostMapping
    @ApiOperation("新增入住信息")
    public AjaxResult add(@ApiParam(value = "入住信息实体", required = true) @RequestBody CheckIn checkIn)
    {
    ...
    @PutMapping
    @ApiOperation("修改入住信息")
    public AjaxResult edit(@ApiParam(value = "入住信息实体", required = true)  @RequestBody CheckIn checkIn)
    {
